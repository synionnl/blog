Feature: Process
    ...
    Scenario: Do not use bot answer
        ...
        When the bot answers the question with a probability smaller then 85%
    ...
    Scenario: Use bot answer
        Given an asked question            
        When the bot answers the question with a probability greater or equal then 85%
        And the gateway "Gateway_UseBotAnswer" is executed
        Then the flow "Flow_UseBotAnswerYes" must be activated

    Scenario: Review bot answer
        Given an asked question            
        When the bot answers the question with a probability greater or equal then 85% and smaller then 95%
    ...
    Scenario: Do not review bot answer
        Given an asked question            
        When the bot answers the question with a probability greater or equal then 95%
        And the gateway "Gateway_ReviewBotAnswer" is executed
